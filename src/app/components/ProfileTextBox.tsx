...
export function ProfileTextBox({ text, boldText, contentText,divPosition }: ProfileTextBoxProps) {
  return (
    <div className={`w-[296px] ${divPosition}`}>
    <span className="font-normal text-sm leading-3 text-[#262626]">{text}{" "}</span>
